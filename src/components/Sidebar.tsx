...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  const navItems = [
    ...
    { to: '/ordenes', icon: ClipboardList, label: 'Órdenes', show: true },
    { to: '/citas', icon: Bell, label: 'Citas por Confirmar', badge: citasCount, show: true },
    { to: '/calendario', icon: Calendar, label: 'Calendario', show: true },
    { to: '/calendarios', icon: CalendarDays, label: 'Calendarios', show: isAdmin || isOperaria || isSecretaria },
    { to: '/standby', icon: Clock, label: 'Stand-by / Piezas', badge: standbyCount, show: true },
    { to: '/mapa', icon: Map, label: 'Mapa de Rutas', show: true },
    { to: '/clientes', icon: Users, label: 'Clientes', show: true },
    { to: '/cotizaciones', icon: FileText, label: 'Cotizaciones', show: isOperaria || isSecretaria },
    { to: '/facturas', icon: Receipt, label: 'Facturas', show: isAdmin || isOperaria },
    { to: '/taller', icon: Wrench, label: 'Equipos Taller', show: true },
    { to: '/productos', icon: ShoppingBag, label: 'Catálogo', show: true },
    { to: '/mantenimiento', icon: Calendar, label: 'Mantenimiento', show: true },
    { to: '/gastos', icon: DollarSign, label: 'Gastos e Ingresos', show: isAdmin },
    { to: '/rendimiento', icon: TrendingUp, label: 'Rendimiento', show: isAdmin || isOperaria },
    { to: '/personal', icon: UserCog, label: 'Personal', show: isAdmin },
    { to: '/usuarios', icon: Shield, label: 'Usuarios & Permisos', show: isAdmin },
