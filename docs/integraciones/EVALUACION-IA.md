...
## Hallazgo de integridad de consulta, 06:19 RD
Con ea62bb0 la IA distinguió urgencia registrada y atención desconocida, pero descartó OS-0010 como eliminada. Verificación directa de Firestore, limitada a número/fase/eliminada: OS-0001 y OS-0010 tienen cada uno un registro vigente y otro eliminado. get_orden_detallada y get_orden usaban limit(1), y la consulta de piezas por número hacía lo mismo; podían elegir el registro eliminado aunque la lista mostrara el vigente. No se cambió ningún dato.
Corrección: buscar las coincidencias del número, seleccionar la única no eliminada, devolver ausencia si todas lo están y error explícito ante varias vigentes. Tres pruebas reproducen selección errónea, ambigüedad y ausencia. Pendiente repetir pregunta de prioridad tras desplegar esta corrección; no considerar correcta la exclusión anterior de OS-0010.

## Prueba real 07:19 RD, 8e74742
La consulta de prioridades recuperó correctamente los dos leads vigentes y su detalle; OS-0010 ya no se confundió con el duplicado eliminado. Usó nota de urgencia de OS-0001 y distinguió falta de registro de una visita confirmada. Estimación visible: 25308 entrada, 731 salida, USD 0.053851. La respuesta sigue siendo larga y propone contacto directo; antes de dar por cerrado el ajuste de estilo, el usuario debe evaluar utilidad con sus casos habituales. No afirmar perfección ni que todo el software está probado. Las llamadas sugeridas no se realizaron.
